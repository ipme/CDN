...
function format_image_thumbnail() {
	...
	if (zm_get_option('lazy_s')) {
		...
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0] . '!/both/'.zm_get_option('img_w').'x'.zm_get_option('img_h').'/format/webp/lossless/true" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][1] . '!/both/'.zm_get_option('img_w').'x'.zm_get_option('img_h').'/format/webp/lossless/true" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][2] . '!/both/'.zm_get_option('img_w').'x'.zm_get_option('img_h').'/format/webp/lossless/true" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][3] . '!/both/'.zm_get_option('img_w').'x'.zm_get_option('img_h').'/format/webp/lossless/true" alt="'.$post->post_title .'" /></a></div></div></div>';
	}
}
