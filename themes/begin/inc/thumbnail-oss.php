...
function format_image_thumbnail() {
	...
	if (zm_get_option('lazy_s')) {
		...
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][1] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][2] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][3] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
	}
}
